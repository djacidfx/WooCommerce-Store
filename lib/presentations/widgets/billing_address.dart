...
class BillingAddress extends StatefulWidget {
  ...
  const BillingAddress({Key? key, required this.email_, required this.firstName_, required this.lastName_})
      : super(key: key);
...
class _BillingAddressState extends State<BillingAddress> {
  ...
  FocusNode focusNodeeEmail = FocusNode();
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<CustomerModel?> snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (snapshot.data!.billing!.firstName!.isEmpty) {
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Center(
                      child: Text(
                        'No data found. Click on the plus icon to add a billing address',
                        style: TextStyle(
                    ...
                    elevatedButton(
                        icon: Icons.add, text: 'Add Billing Address', onPressed: () => showFormBottomSheet(true))
                  ],
                ),
              );
            } else {
              var details = snapshot.data!.billing;
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      elevatedButton(
                          icon: Icons.edit, text: 'Edit Billing Address', onPressed: () => showFormBottomSheet(false, details: details)),
                    ],
                  ),
                ),
              );
  ...
  Future showFormBottomSheet(bool isAdd, {Billing? details
}) async {
      if (isAdd == false) {
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    Center(
                      child: Text(
                        isAdd ? 'Add Billing Address' : 'Update Billing Address',
                        ...
                        onPressed: () {
                          if (validateAndSave()) {
                            ...
                            _customerDetailsProvider
                                .updateBillingDetails(widget.firstName_, widget.lastName_, widget.email_, context,
