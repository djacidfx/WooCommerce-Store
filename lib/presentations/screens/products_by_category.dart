...
import 'package:woocommerce/presentations/widgets/leading.dart';
...
class ProductByCategoryScreen extends StatefulWidget {
  ...
  const ProductByCategoryScreen({Key? key, required this.categoryId, required this.categoryName}) : super(key: key);
...
class _ProductByCategoryScreenState extends State<ProductByCategoryScreen> {
  ...
  void initState() {
    ...
    productList.fetchProducts(_page, categoryId: widget.categoryId);
  ...
  _onSearchChange() {
    ...
    _debounce = Timer(const Duration(milliseconds: 7000), () {
      ...
      productsList.fetchProducts(_page, categoryId: widget.categoryId, strSearch: _searchQuery.text);
    });
  }
        ...
        : Container(
              ...
              child: TextField(
                ...
                onEditingComplete: () {
                  ...
                  productsList.resetStreams();
                  productsList.setLoadingState(LoadMoreStatus.INITIAL);
                  productsList.fetchProducts(_page, categoryId: widget.categoryId,
