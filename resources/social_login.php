...
class Auth {
	 ...
	 */
	public function authenticate_user( $username, $password, $custom_auth = '', $social_login = false ) {
	...
	public function get_token( WP_REST_Request $request ) {
		...
		$social_login = $request->get_param( 'social_login' );
		...
		$user = $this->authenticate_user( $username, $password, $custom_auth, $social_login );
